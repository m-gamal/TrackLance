...
@section('title') Add New project @endsection
            ...
            <div class="portlet light ">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="input-icon">
                            ...
                            <input type="text" name ="type" class="form-control" placeholder="Project Type" value="{{old('type')}}">
                            @if($errors->has('type'))
                                <div class="alert alert-danger">
                                    <i class="fa fa-warning"></i>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="input-icon">
                            ...
                            <input type="text" name ="start" class="form-control date-picker" placeholder="Start Date" data-date-format="yyyy-mm-dd" value="{{old('start')}}">
                            @if($errors->has('start'))
                                <div class="alert alert-danger">
                                    <i class="fa fa-warning"></i>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="input-icon">
                            <i class="fa fa-calendar font-green"></i>
                            <input type="text" name="end" class="form-control date-picker" placeholder="End Date" data-date-format="yyyy-mm-dd" value="{{old('end')}}" />
                            @if($errors->has('end'))
                                <div class="alert alert-danger">
                                    <i class="fa fa-warning"></i>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="input-icon">
                            ...
                            <input type="text" name ="milestone" class="form-control" placeholder="Milestone Percent" value="{{old('milestone')}}">
